...
function usage() {
    ...
    echo "$COMMAND configure : configure the OAI5G charts for the target scenario"
    echo "                    configure must only be run after a fresh pull, i.e., 2 consecutive configure will fail."
    exit 1
}
