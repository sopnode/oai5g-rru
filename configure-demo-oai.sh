...
s|@DEF_TAC@|${TAC}|g
s|@DEF_DNN0@|${DNN0}|g
s|@DEF_DNN0_PDU_TYPE@|${DNN0_PDU_TYPE}|g
s|@DEF_DNN1@|${DNN1}|g
s|@DEF_DNN1_PDU_TYPE@|${DNN1_PDU_TYPE}|g
s|@DEF_SLICE1_SST@|${SLICE1_SST}|g
s|@DEF_SLICE1_SD@|${SLICE1_SD}|g
s|@DEF_SLICE1_5QI@|${SLICE1_5QI}|g
s|@DEF_SLICE1_ARP_PRIORITY_LEVEL@|${SLICE1_ARP_PRIORITY_LEVEL}|g
s|@DEF_SLICE1_ARP_PREEMPT_CAP@|${SLICE1_ARP_PREEMPT_CAP}|g
s|@DEF_SLICE1_ARP_PREEMPT_VULN@|${SLICE1_ARP_PREEMPT_VULN}|g
s|@DEF_SLICE1_PRIORITY_LEVEL@|${SLICE1_PRIORITY_LEVEL}|g
s|@DEF_SLICE1_UPLINK@|${SLICE1_UPLINK}|g
s|@DEF_SLICE1_DOWNLINK@|${SLICE1_DOWNLINK}|g
s|@DEF_SLICE2_SST@|${SLICE2_SST}|g
s|@DEF_SLICE2_SD@|${SLICE2_SD}|g
s|@DEF_SLICE2_5QI@|${SLICE2_5QI}|g
s|@DEF_SLICE2_ARP_PRIORITY_LEVEL@|${SLICE2_ARP_PRIORITY_LEVEL}|g
s|@DEF_SLICE2_ARP_PREEMPT_CAP@|${SLICE2_ARP_PREEMPT_CAP}|g
s|@DEF_SLICE2_ARP_PREEMPT_VULN@|${SLICE2_ARP_PREEMPT_VULN}|g
s|@DEF_SLICE2_PRIORITY_LEVEL@|${SLICE2_PRIORITY_LEVEL}|g
s|@DEF_SLICE2_UPLINK@|${SLICE2_UPLINK}|g
s|@DEF_SLICE2_DOWNLINK@|${SLICE2_DOWNLINK}|g
s|@DEF_GNB_ID@|${GNB_ID}|
