...
if [[ $GNB_ONLY = "true" ]]; then
    ...
    IF_NAME_UPF_N3="eth2"
    IF_N4="n3"
    NFS_AMF_HOST="172.20.255.4" # was "oai-amf"
    NFS_SMF_HOST="172.20.247.211" # was "oai-smf"
    NFS_UPF_HOST="oai-upf" # was "oai-upf"
    NFS_UDM_HOST="172.20.216.131" # was "oai-udm"
    NFS_UDR_HOST="172.20.11.135" # was "oai-udr"
    NFS_AUSF_HOST="172.20.132.139" # was "oai-ausf"
    NFS_NRF_HOST="172.20.161.135" # was "oai-nrf"
