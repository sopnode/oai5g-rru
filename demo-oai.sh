...
IF_NAME_VLAN_N300_1="@DEF_LOCAL_INTERFACE@"
IF_NAME_VLAN_N300_2="@DEF_LOCAL_INTERFACE@"
IF_NAME_VLAN_N320_1="@DEF_LOCAL_INTERFACE@"
IF_NAME_VLAN_N320_2="@DEF_LOCAL_INTERFACE@"
IF_NAME_VLAN_JAGUAR="jaguar_1"
IF_NAME_VLAN_PANTHER="panther_1"
...
if [[ $RU_MODE = "dhcp" ]]; then
    ...
    IP_GNB_N300_1="192.168.233.110" # @IP N300.1 + 7
    IP_GNB_N300_2="192.168.233.111" # @IP N300.2 + 7
    IP_GNB_N320_1="192.168.233.112" # @IP N320.1 + 7
...
OPTIONS_aw2s="--log_config.global_log_options level,nocolor,time"
if [[ $RU_MODE = "dhcp" ]]; then
    IP_GNB_jaguar="dhcp"
    IP_GNB_panther="dhcp"
else
