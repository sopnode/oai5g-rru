...
GW_UPF_N3="172.21.10.11"
#ROUTES_UPF_N3=""
ROUTES_UPF_N3="[{'dst': '0.0.0.0/24','gw': '172.21.10.11'}]"
#ROUTES_UPF_N3="[{'dst': '192.168.128.0/24','gw': '192.168.128.129'},{'dst': '172.21.0.0/16','gw': '192.168.128.129'}]"
...
ROUTES_GNB_N2=""
#ROUTES_GNB_N2="[{'dst': '172.21.92.0/24','dev': 'n2'}]"
...
CONF_rfsim="gnb.sa.band78.106prb.rfsim.2x2.conf-demo" 
...
CONF_jaguar="gnb.sa.band78.51prb.aw2s.ddsuu.conf-old-demo"
...
if [[ $GNB_ONLY = "true" ]]; then
    ...
    IP_AMF_N2="192.168.128.195" # external AMF IP address, e.g., "172.22.10.6"
    # Set the local host network interface to reach AMF/UPF
    NETMASK_AMF_N2="27"
    IF_NAME_GNB_N2="eth2" # Host network interface to reach AMF/UPF
    # Set the local IP address of the latter network interface
    IP_GNB_N2N3="192.168.128.131" 
    NETMASK_GNB_N2="27"
