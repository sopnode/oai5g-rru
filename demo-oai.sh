...
#
HOST_AMF="oai-amf"
NODE_CU="$NODE_GNB" # same node used for cu/cu-cp/cu-up
...
NRUE_TAG="${RAN_TAG}"
OPTIONS_NRUE="--sa -E --rfsim -r 106 --numerology 1 -C 3319680000 --log_config.global_log_options level,nocolor,time"
