...
if [[ $GNB_ONLY = "true" ]]; then
    ...
    IF_NAME_UPF_N3="eth2"
    IF_N4="n3"
    NFS_AMF_HOST="172.20.33.175" # was "oai-amf"
    NFS_SMF_HOST="172.20.193.142" # was "oai-smf"
    NFS_UPF_HOST="oai-upf" # was "oai-upf"
    NFS_UDM_HOST="172.20.220.97" # was "oai-udm"
    NFS_UDR_HOST="172.20.56.43" # was "oai-udr"
    NFS_AUSF_HOST="172.20.91.83" # was "oai-ausf"
    NFS_NRF_HOST="172.20.250.31" # was "oai-nrf"
