...
if [[ $GNB_ONLY = "true" ]]; then
    ...
    IF_NAME_UPF_N3="eth2"
    IF_N4="n3"
    NFS_AMF_HOST="172.20.208.35" # was "oai-amf"
    NFS_SMF_HOST="172.20.51.181" # was "oai-smf"
    NFS_UPF_HOST="oai-upf" # was "oai-upf"
    NFS_UDM_HOST="172.20.119.219" # was "oai-udm"
    NFS_UDR_HOST="172.20.204.217" # was "oai-udr"
    NFS_AUSF_HOST="172.20.107.84" # was "oai-ausf"
    NFS_NRF_HOST="172.20.197.251" # was "oai-nrf"
