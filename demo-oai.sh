...
function get-ran-pcap(){
    ...
    echo "kubectl -c tcpdump cp $ns/$GNB_PODNAME:ran-net1-pcap.tgz $prefix/ran-net1-pcap-"$DATE".tgz"
    ...
    echo "kubectl -c tcpdump cp $ns/$GNB_PODNAME:ran-net2-pcap.tgz $prefix/ran-net2-pcap-"$DATE".tgz"
