...
NRUE_TAG="${RAN_TAG}"
OPTIONS_NRUE="-C 3619200000 -r 106 --numerology 1 --ssb 516 -E 
#OPTIONS_NRUE="-C 3619200000 -r 106 --numerology 1 --ssb 516 -E  --log_config.global_log_options level,nocolor,time" # for latest DU RFSIM conf ?
#OPTIONS_NRUE="-C 3319680000 -r 106 --numerology 1 --ssb 516 -E  --log_config.global_log_options level,nocolor,time"
